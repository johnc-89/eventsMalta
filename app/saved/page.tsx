...
export default function SavedEventsPage() {
  ...
  if (!user) {
    return (
      <main className="max-w-2xl mx-auto px-4 py-16 text-center">
        <h1 className="text-2xl font-heading font-bold text-brand-dark mb-4">Log in to see saved events</h1>
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-heading font-bold text-brand-dark mb-6">Saved Events</h1>
